...
`different_entities` records an explicit non-identity constraint between two durable entity IDs. Entity Resolution uses this constraint to avoid treating the pair as interchangeable in later matching.
